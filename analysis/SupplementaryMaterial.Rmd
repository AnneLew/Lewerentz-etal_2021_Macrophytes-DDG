...
## TODO: Alternative GAMM with selected parameters
Selected: Ntot
...
p6<-plotGAMM(gam_AlphaPeakRichness_alternative, smooth.cov = "SAC")  +
    geom_point(data = PEAK_Chem_norm_BA, aes_string(y = "AlphaPeakRichness", x = "SAC"), alpha = 0.2) +
    geom_rug(data = PEAK_Chem_norm_BA, aes_string(y = "AlphaPeakRichness", x = "SAC"), alpha = 0.2) +
    theme(legend.position="none")+
    ylab(expression(predicted_R[alpha][max]))+
    ggtitle("")+  theme(legend.title = element_blank())
